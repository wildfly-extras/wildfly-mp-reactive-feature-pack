...
```
galleon.sh install org.wildfly.extras.reactive:wildfly-microprofile-reactive-feature-pack:1.0.0.Beta3-SNAPSHOT --layers=reactive-streams-operators,context-propagation --dir=wildfly
``` 
----
## References
