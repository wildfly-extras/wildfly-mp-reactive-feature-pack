...
```
galleon.sh install org.wildfly.extras.reactive:wildfly-microprofile-reactive-feature-pack:1.0.3.Final-SNAPSHOT --layers=microprofile-reactive-all --dir=wildfly
``` 
...
<!-- Should be SNAPSHOT while working and not when we do a release -->
```
galleon.sh install org.wildfly.extras.reactive:wildfly-microprofile-reactive-feature-pack:1.0.3.Final-SNAPSHOT --layers=microprofile-reactive-streams-operators,microprofile-context-propagation --dir=wildfly
``` 
----
## References
