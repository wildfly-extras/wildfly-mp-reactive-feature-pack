...
```
galleon.sh install org.wildfly.extras.reactive:wildfly-microprofile-reactive-feature-pack:2.0.0.Final --layers=microprofile-reactive-all --dir=wildfly
```
...
<!-- Should be SNAPSHOT while working and not when we do a release -->
```
galleon.sh install org.wildfly.extras.reactive:wildfly-microprofile-reactive-feature-pack:2.0.0.Final --layers=microprofile-reactive-streams-operators,microprofile-context-propagation --dir=wildfly
```
----
## References
