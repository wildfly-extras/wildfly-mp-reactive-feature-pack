...
package org.wildfly.extension.microprofile.context.propagation._private;
...
public interface MicroProfileContextPropagationLogger extends BasicLogger {

    MicroProfileContextPropagationLogger LOGGER = Logger.getMessageLogger(MicroProfileContextPropagationLogger.class, "org.wildfly.extension.microprofile.reactive-streams-operators-smallrye");

    /**
     * Logs an informational message indicating the subsystem is being activated.
     */
    @LogMessage(level = INFO)
    @Message(id = 1, value = "Activating Eclipse MicroProfile Context Propagation Subsystem")
